        ...
        <div class="flex justify-between">
            ...
            <div class="col w-[400px]">
                <div class="sticky top-[20px]">
                    ...
                    <div class="flex mt-[10px] gap-[7px] items-center justify-end   ">
                        <form action="/dashboard/delete/{{ $gig->id }}" method="post" class="text-center">
                            @csrf
                            @method('delete')
                            <button type="submit"
                                class="bg-[#ff3333] text-white text-[13px] py-[6px] px-[11px] font-medium tracking-wider rounded-[3px]"
